...
- Share posts directly to another user's DM with a post preview

## Setup

1. Replace the files in your GitHub Pages repository with these files. Keep the same Supabase URL and publishable key that are already working in your current app.js.
